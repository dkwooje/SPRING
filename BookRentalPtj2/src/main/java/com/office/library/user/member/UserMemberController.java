...
@Controller
@RequestMapping("/user/member") //공용 주소
...
//	@RequestMapping(value = "/loginConfirm", method = RequestMethod.POST)
	...
	public String loginConfirm(UserMemberVo userMemberVo, HttpSession session) { //사용자로그인의 정보 Session에 저장된다.
...
//	@RequestMapping(value = "/modifyAccountForm", method = RequestMethod.GET)
	...
	public String modifyAccountForm(HttpSession session) {
		...
		if (loginedUserMemberVo == null) {nextPage = "redirect:/user/member/loginForm";}
		return nextPage;	
	}
